...
The processor owns DSP, bounded SPSC publication, BufferHunter, observation lifetime and bounded context. The editor renders full-resolution power and continuous float32 meters and selects one of four validated profiles. [DSP configuration](DSP_CONFIGURATION.md) separates measurement from presentation. aifred_filter is the only structured analysis boundary. AifredIntelligenceHost routes provider transport on channel beta, port 8787. No Python runtime or duplicate analyzer participates.
