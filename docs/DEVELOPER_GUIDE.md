...
```sh
./apps/admin-desktop/macos/build.sh
```

The Android build requires SDK 35/JDK 17. Windows installer and Desktop Admin runtime validation require Windows/PowerShell.
