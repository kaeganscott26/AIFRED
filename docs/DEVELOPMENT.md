...
Read [architecture](ARCHITECTURE.md), [shared algorithms](../shared-dsp/README.md), [build](BUILD.md) and [testing](TESTING.md). Preserve frontends and audio/state IDs. Measurements belong only to the shared DSP analyzer, observation to BufferHunter, semantics to aifred_filter. Network/model/file operations never reach processBlock.
